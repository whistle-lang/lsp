...
export async function activate(context: ExtensionContext) {
    ...
    const traceOutputChannel = window.createOutputChannel("Testwhistle Language Server trace");
    ...
    client = new LanguageClient("whistle_lsp", "testwhistle language server", serverOptions, clientOptions);
    ...
    const maybeUpdater = {
        ...
        async onConfigChange() {
            ...
            this.hintsProvider = languages.registerInlayHintsProvider(
                { scheme: "file", language: "testwhistle" },
